...
<body>
    <div class="container-fluid">
        ...
        <div class="row d-flex align-items-center justify-content-center mt-1 pt-1 ">
            ...
            <div class="col-2">
                <select class="form-select ts-input" name="associados" id="FiltroAssociados">
                    <option value="null">Todos</option>
                    <option value="associados">Associados</option>
                    <option value="naoassociados">NÃ£o Associados</option>
                </select>
            </div>
...
e gás natural">7 - Estrangeira - Adquirida no mercado interno</option>
                    ...
                    <form method="post" id="form-alterarProdutos">
                        <div class="modal-body">
                            ...
                            <div class="row mt-2">
                                <div class="col-md">
                                    <label class="form-label ts-label">Fornecedor</label>
                                    <input type="hidden" class="form-control ts-input" name="idPessoaFornecedor" id="viewProd_idPessoaFornecedor" readonly>
                                    <input type="text" class="form-control ts-input" id="viewProd_nomeFantasia" disabled>
                                </div>
                                <div class="col-md">
                                    <label class="form-label ts-label">cpf/Cnpj</label>
                                    <input type="text" class="form-control ts-input" id="viewProd_cpfCnpj" disabled>
                                </div>
                                <div class="col-md">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-2">
                                    <label class="form-label ts-label">idGeralProduto</label>
                                    <input type="text" class="form-control ts-input" id="geral_idGeralProduto" readonly>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label ts-label">eanProduto</label>
                                    <input type="text" class="form-control ts-input" name="eanProduto" id="geral_eanProduto" readonly>
                                </div>
                                <div class="col-md">
                                    <label class="form-label ts-label">nomeProduto</label>
                                    <input type="text" class="form-control ts-input" id="geral_nomeProduto" readonly>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md">
                                    <label class="form-label ts-label">codImendes</label>
                                    <input type="text" class="form-control ts-input" name="codImendes" id="geral_codImendes" readonly>
                                </div>
                                <div class="col-md">
                                    <label class="form-label ts-label">prodZFM</label>
                                    <input type="text" class="form-control ts-input" name="prodZFM" id="geral_prodZFM" readonly>
                                </div>
                                <div class="col-md">
                                    <label class="form-label ts-label">idMarca</label>
                                    <input type="text" class="form-control ts-input" name="idMarca" id="geral_idMarca" readonly>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-2">
                                    <label class="form-label ts-label">idGrupo</label>
                                    <input type="text" class="form-control ts-input" name="idGrupo" id="geral_idGrupo" readonly>
                                </div>
                                <div class="col-md">
                                    <label class="form-label ts-label">nomeGrupo</label>
                                    <input type="text" class="form-control ts-input" id="geral_nomeGrupo" readonly>
                                </div>
                            </div>
                            <hr>
                            <div class="row mt-2">
                                <div class="col-md">
                                    <label class="form-label ts-label">idFornecimento</label>
                                    <input type="text" class="form-control ts-input" id="fornecimento_idFornecimento" readonly>
                                </div>
                                <div class="col-md">
                                    <label class="form-label ts-label">Att trib.</label>
                                    <input type="text" class="form-control ts-input" name="dataAtualizacaoTributaria" id="fornecimento_dataAtualizacaoTributaria" readonly>
                                </div>
                            </div>
                        </div><!--body-->
    ...
    <script>
        ...
        buscar($("#buscaProduto").val(), $("#FiltroAssociados").val());
        ...
        function buscar(buscaProduto, FiltroAssociados) {
            //alert(buscaProduto);
            $.ajax({
                type: 'POST',
                dataType: 'html',
        ...
        $("#FiltroAssociados").change(function() {
            buscar($("#buscaProduto").val(), $("#FiltroAssociados").val());
        })
        ...
        $(document).on('click', 'button[data-bs-target="#visualizarProdutoModal"]', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#viewProd_nomeFantasia').val(data.nomeFantasia);
                    $('#viewProd_cpfCnpj').val(data.cpfCnpj);
                    ...
                    //GeralProdutos   
                    $('#geral_idGeralProduto').val(data.geral_idGeralProduto);
                    $('#geral_eanProduto').val(data.geral_eanProduto);
                    $('#geral_nomeProduto').val(data.geral_nomeProduto);
                    $('#geral_codImendes').val(data.codImendes);
                    $('#geral_idGrupo').val(data.idGrupo);
                    $('#geral_nomeGrupo').val(data.nomeGrupo);
                    $('#geral_prodZFM').val(data.prodZFM);
                    $('#geral_idMarca').val(data.idMarca);

                    //GeralFornecimento
                    $('#fornecimento_idFornecimento').val(data.idFornecimento);
                    if (data.dataAtualizacaoTributaria == null) {
                        vAtt_trib = '';
                    } else {
                        vAtt_trib = formatarData(data.dataAtualizacaoTributaria);
                    }
                    $('#fornecimento_dataAtualizacaoTributaria').val(vAtt_trib);
